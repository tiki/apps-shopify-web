...
export function AppliesToChoices({
  onChange = (list: Resource[], resource: ResourceOptions) =>
      ...
      {res === 'products' ? (
        <>
          <TextField
            ...
            connectedRight={
              <Button onClick={() => setOpen(true)}>Browse products</Button>
            }
          />
          <ResourcePicker
            ...
            onSelection={(selectPayload: SelectPayload) => {
              handleProductList(
                selectPayload.selection as Product[],
                'products',
              );
            }}
          />
          ...
          <ResourcePicker
            ...
            onSelection={(selectPayload: SelectPayload) => {
              handleCollectionList(
                selectPayload.selection as Collection[],
                'collections',
              );
            }}
          />
