export default `User Data License Agreement
...
Collected Data: Order details      
Use Cases: %%%USE_CASES%%%
Destination: mytiki.com

Description: Your data will be used to extract SKU level insights and signals about your completed orders and its items.
2. Compensation
...
A. Offer
We, Acme Inc., agree to compensate you, the User, for granting us a license to use your Shared Information in exchange for a discount in the Store, identified as '%%%DISCOUNT%%%'
B. Duration
The license is valid until %%%DISCOUNT_END_DATE%%%
C. Termination
...
When you, the User, agree to the data licensing program, you agree to the collection of Shared Information by the Company, which may include zero, first, and third-party data covered under our Terms of Service %%%TOS_URL%%%) and Privacy Policy (%%%PRIVACY_POLICY_URL%%%)).
...
6. Governing Law
The governing law of this agreement %%%ADDRESS%%%, where the company is located or headquartered.
7. Data Ownership
